...
namespace ViewWindow.Model
{
    ...
    public class ROIRectangle1 : ROI
    {
        ...
        public override void draw(HalconDotNet.HWindow window)
        {
            ...
            window.DispRectangle2(row1, col1, 0, Msize.Width, Msize.Height);
            window.DispRectangle2(row1, col2, 0, Msize.Width, Msize.Height);
            window.DispRectangle2(row2, col2, 0, Msize.Width, Msize.Height);
            window.DispRectangle2(row2, col1, 0, Msize.Width, Msize.Height);
