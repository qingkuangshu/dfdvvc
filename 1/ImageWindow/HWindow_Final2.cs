...
namespace ChoiceTech.Halcon.Control
{
    ...
    /// </summary>
    public partial class HWindow_Final2 : UserControl
    {
        #region 私有变量定义.
        ...
        public HTuple HWindowHalconID
        {
            get
            {
                //return this.mCtrl_HWindow.HalconID;//intprt
                return hWindowControl.HalconWindow;
            }
        }
        ...
        //public void DispText(string htext, string color, int row, int col, int size, string font, string bold, string slant)
        //{
        //    lock (this)
        //    {
        ...
        ///// <param name="bold">true代表粗体，false代表不粗体</param>
        ///// <param name="slant">true代表斜体，false代表不斜体</param>
        //public void DispText(string htext, string color, string row, string col, int size, string font, string bold, string slant)
        //{
        //    lock (this)
        //    {
