...
public partial class HDevelopExport
{
  ...
  private void action()
  {
    ...
    try
    {
      ...
      HOperatorSet.ReadDict("D:/Project/1.╒¤╕║╝л╝л╞м╚▒╧▌╝ь▓т/╤╡┴╖─г╨═/2022-10-10─г╨═║═│╠╨Є/New_Model/╕║╝л╝л╞м╚▒╧▌╙я╥х╖╓╕ю.hdict", 
          new HTuple(), new HTuple(), out hv_DictHandle);
      //┤╙╙я╥х╖╓╕ю╡╝│Ў╡─╬─╝■╡▒╓╨╗ё╚б╖╓╕ю╡─╨Є║┼╥╘╝░└р▒Ё╦ў╥¤
      hv_ClassNames.Dispose();
      ...
      //write_dict (DictHandle, 'D:/╕║╝л╖╓╕ю.hdict', [], [])
      //read_dict ('D:/╕║╝л╖╓╕ю.hdict', [], [], DictHandle1)
      ...
      hv_ImageFiles.Dispose();
      HOperatorSet.ListFiles("D:/Project/1.╒¤╕║╝л╝л╞м╚▒╧▌╝ь▓т/OK", (new HTuple("files")).TupleConcat(
          ...
          ))-1); hv_Index = (int)hv_Index + 1)
      {
        ...
        //DLPreprocessParam╬к╘д┤ж└э▓╬╩¤╛ф▒·гм═╞▓т╩╟╕∙╛▌╘д┤ж└э▓╬╩¤╢╘▒╛┤╬═╝╧ё╜°╨╨╘д┤ж└э
        ...
        //═и╣¤╙я╥х╖╓╕ю▒ъ╝╟╡─╨Є║┼╫ў╬к╗╥╢╚╓╡гм╡├╡╜╕ў╓╓└р╨═╡─╟°╙Єгм╚Ї╕├└р╨═├╗╙╨╡─╗░гм╘Є╟°╙Є╬к0
